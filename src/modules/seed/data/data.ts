import { SeedData } from '../interfaces/seed';

export const data: SeedData = {
  users: [
    {
      name: 'Quent Hordell',
      email: 'qhordell0@noaa.gov',
      password: 'UEBNAM4LTDkL',
      active: true,
    },
    {
      name: 'Josefina McGucken',
      email: 'jmcgucken1@shinystat.com',
      password: '4Ft45M9bB7M',
      active: false,
    },
    {
      name: 'Fredia Bossingham',
      email: 'fbossingham2@constantcontact.com',
      password: 'mqgBLlsu8',
      active: false,
    },
    {
      name: 'Roobbie Bresson',
      email: 'rbresson3@booking.com',
      password: 'HDLCwBRa',
      active: true,
    },
    {
      name: 'Dante Guilaem',
      email: 'dguilaem4@moonfruit.com',
      password: 'RTBQgHJHK6d',
      active: true,
    },
    {
      name: 'Jerrie Casellas',
      email: 'jcasellas5@umich.edu',
      password: '28CICXml33fj',
      active: true,
    },
    {
      name: 'Milzie Barradell',
      email: 'mbarradell6@smh.com.au',
      password: 'bnL7jvHo',
      active: false,
    },
    {
      name: 'Lavinie Craighall',
      email: 'lcraighall7@ox.ac.uk',
      password: 'ChmxTy5',
      active: true,
    },
    {
      name: 'Melinde Merricks',
      email: 'mmerricks8@ocn.ne.jp',
      password: 'sKxIxPB4s',
      active: false,
    },
    {
      name: 'Mohandas Clarae',
      email: 'mclarae9@wikia.com',
      password: 'w4gd8GV4C7A',
      active: true,
    },
    {
      name: 'Leonidas Jakoviljevic',
      email: 'ljakoviljevica@eepurl.com',
      password: 'yO2rVj2',
      active: false,
    },
    {
      name: 'Garey Heeley',
      email: 'gheeleyb@google.nl',
      password: 's2NBUN',
      active: false,
    },
    {
      name: 'Jeth Danielian',
      email: 'jdanielianc@jimdo.com',
      password: 'ynJ4Uj5',
      active: false,
    },
    {
    ...
    {
      name: 'Thea Rishbrook',
      email: 'trishbrooke@de.vu',
      password: 'rG2SVLUJ',
      active: true,
    },
    {
      name: 'Lenka Sennett',
      email: 'lsennettf@about.me',
      password: 'qBQ64wVB',
      active: false,
    },
    {
      name: 'Reece Bendixen',
      email: 'rbendixeng@nature.com',
      password: 'Iv08Akouu',
      active: false,
    },
    {
      name: 'Kassey Franzen',
      email: 'kfranzenh@hao123.com',
      password: 'VPGQIqTA5zX1',
      active: false,
    },
    {
      name: 'Lainey Knowlton',
      email: 'lknowltoni@opera.com',
      password: 'TNu2zVw',
      active: true,
    },
    {
      name: 'Anthia Hazeldean',
      email: 'ahazeldeanj@parallels.com',
      password: 'hlGaxst',
      active: true,
    },
    {
      name: 'Davy Yakob',
      email: 'dyakobk@nba.com',
      password: '7hoFjufwn',
      active: true,
    },
    {
      name: 'Rochella Avesque',
      email: 'ravesquel@uiuc.edu',
      password: 'bjRDUuilxYdB',
      active: false,
    },
    {
      name: 'Lurline Selesnick',
      email: 'lselesnickm@google.pl',
      password: 'XWDqRGT2H0',
      active: false,
    },
    {
      name: 'Karoline Coultass',
      email: 'kcoultassn@state.gov',
      password: 'r6MvRLSR2HV',
      active: true,
    },
    {
      name: 'Loutitia McKelvey',
      email: 'lmckelveyo@huffingtonpost.com',
      password: 'ipJ9Q3C',
      active: true,
    },
    {
      name: 'Nannie Ochterlonie',
      email: 'nochterloniep@columbia.edu',
      password: '2sGMKhco',
      active: false,
    },
    {
      name: 'Angelica Cauley',
      email: 'acauleyq@hp.com',
      password: '2mXFd9',
      active: false,
    },
    {
      name: 'Gilberta Neath',
      email: 'gneathr@census.gov',
      password: 'CfBRRdaWU',
      active: false,
    },
    {
      name: 'Lizzy Piken',
      email: 'lpikens@nasa.gov',
      password: '2ORsWFFAW0',
      active: false,
    },
    {
      name: 'Garreth Archbould',
      email: 'garchbouldt@uiuc.edu',
      password: 'ugBWbKKTtO8t',
      active: true,
    },
    {
      name: 'Angelica Treffrey',
      email: 'atreffreyu@uiuc.edu',
      password: '4B7NMY',
      active: false,
    },
    {
      name: 'Courtnay Kubacki',
      email: 'ckubackiv@51.la',
      password: 'xS2jPU',
      active: false,
    },
    {
      name: 'Dew Goublier',
      email: 'dgoublierw@aol.com',
      password: '2dqiqrNoHPSH',
      active: false,
    },
    {
      name: 'Xever Rattenbury',
      email: 'xrattenburyx@so-net.ne.jp',
      password: '58jy49',
      active: true,
    },
    {
      name: 'Gino Backshaw',
      email: 'gbackshawy@apache.org',
      password: 'oudTwor2tnuR',
      active: false,
    },
    {
      name: 'Pia Causon',
      email: 'pcausonz@yolasite.com',
      password: '3pbQQq2sOvlT',
      active: true,
    },
    {
      name: 'Jacobo MacNeill',
      email: 'jmacneill10@house.gov',
      password: 'MeCBv8z00kYc',
      active: true,
    },
    {
      name: 'Cass Nears',
      email: 'cnears11@tiny.cc',
      password: '1hcVzPW',
      active: true,
    },
    {
      name: 'Fredrika Bernardy',
      email: 'fbernardy12@blogs.com',
      password: 'HWFPCMUkm',
      active: false,
    },
    {
      name: 'Maurise Espley',
      email: 'mespley13@umich.edu',
      password: 'E8nRj2cvlh',
      active: false,
    },
    {
      name: 'Pavia Vinter',
      email: 'pvinter14@sohu.com',
      password: 'XYTJHv',
      active: false,
    },
    {
      name: 'Mattie Antonowicz',
      email: 'mantonowicz15@ed.gov',
      password: 'hhfuPCIl',
      active: false,
    },
    {
      name: 'Gabi Koles',
      email: 'gkoles16@squidoo.com',
      password: 'PqKqdLd',
      active: false,
    },
    {
      name: 'Lemuel Boness',
      email: 'lboness17@europa.eu',
      password: 'BvlmiK',
      active: false,
    },
    {
      name: 'Broderick Akhurst',
      email: 'bakhurst18@unesco.org',
      password: 'cEubKTR',
      active: false,
    },
    {
      name: 'Free Rachuig',
      email: 'frachuig19@liveinternet.ru',
      password: 'V2z6IodveSlD',
      active: false,
    },
    {
      name: 'Margit Birth',
      email: 'mbirth1a@symantec.com',
      password: 'RUT2YLu',
      active: false,
    },
    {
      name: 'Fairleigh Gore',
      email: 'fgore1b@harvard.edu',
      password: 'CSrFsJUNk',
      active: true,
    },
    {
      name: 'Melody Barriball',
      email: 'mbarriball1c@linkedin.com',
      password: 'LLqS3utVZ',
      active: true,
    },
    {
      name: 'Samara Lanston',
      email: 'slanston1d@studiopress.com',
      password: 'T3GDLAx',
      active: true,
    },
  ],
